...
def update_data(n, val):  # input parameter(s)
    if n == None:
        return "Hey there! Please enter a legitimate stock code to get details.", "https://tse2.mm.bing.net/th?id=OIP.3NPD9WEpj0-rOqUJfid-yAHaEK&pid=Api&P=0&h=180", "Stocks", None, None, None
        # raise PreventUpdate
    else:
        if val == None:
            raise PreventUpdate
            ...
            long_summary = df['longBusinessSummary'].values[0]
